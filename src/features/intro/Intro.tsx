    ...
    <div className={className}>
      ...
      <div className="mt-8 sm:hidden">
        <a
          ...
          className="inline-flex items-center gap-2 px-5 py-2.5 bg-white/35 dark:bg-gray-800/50 backdrop-blur-xl border-2 border-white/50 dark:border-gray-600/60 rounded-full shadow-2xl transition-all duration-300 font-bold text-lg"
          style={{ color: "tomato" }}
        >
          <span>Resume</span>
          <svg
